  ...
  int x_size[1], double J_data[], int J_size[2])
{
  ...
  for (i18 = 0; i18 < loop_ub; i18++) {
    Cmm1_tmp_data[i18] = param[2] - x_data[i18];
  }

  param_size[0] = x_size[0];
  loop_ub = x_size[0];
  for (i18 = 0; i18 < loop_ub; i18++) {
    param_data[i18] = param[3] * Cmm1_tmp_data[i18];
  }
  ...
  loop_ub = Cmm1_size[0];
  for (i18 = 0; i18 < loop_ub; i18++) {
    Cmm2_data[i18] = 1.0 + Cmm1_data[i18];
  }

  tmp_size_idx_0 = Cmm2_size[0];
  loop_ub = Cmm2_size[0];
  for (i18 = 0; i18 < loop_ub; i18++) {
    tmp_data[i18] = 1.0 / Cmm2_data[i18];
  }

  for (i18 = 0; i18 < tmp_size_idx_0; i18++) {
    J_data[i18] = 1.0 - tmp_data[i18];
  }

  for (i18 = 0; i18 < tmp_size_idx_0; i18++) {
    J_data[i18 + J_size[0]] = tmp_data[i18];
  }

/*
 * _coder_Coder_RT_PCR_analyzer_api.c
 *
 * Code generation for function '_coder_Coder_RT_PCR_analyzer_api'
 *
 */
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Coder_RT_PCR_analyzer",             /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
void Coder_RT_PCR_analyzer_api(const mxArray * const prhs[19], int32_T nlhs,
  const mxArray *plhs[21])
{
  ...
  real_T AR;
  real_T isPC;
  real_T LinearFilter_type;
  real_T ABSD_corrector_ver;
  real_T AsymmSigFit_ver;
  real_T UseStrangePatternCorrector;
  real_T result_well;
  ...
  LinearFilter_type = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[15]),
    "LinearFilter_type");
  ABSD_corrector_ver = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[16]),
    "ABSD_corrector_ver");
  AsymmSigFit_ver = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[17]),
    "AsymmSigFit_ver");
  UseStrangePatternCorrector = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[18]),
    "UseStrangePatternCorrector");

  /* Invoke the target function */
  Coder_RT_PCR_analyzer(*x_data, x_size, *RD_data, RD_size, *perturbation_data,
                        perturbation_size, SFC, MFC, DRFU, Thrd, RPC, RC, dfM,
                        dfC, PMC, FB, AR, isPC, LinearFilter_type,
                        ABSD_corrector_ver, AsymmSigFit_ver,
                        UseStrangePatternCorrector, &result_well,
                        &DataProcessNum, *DataProcess_data, DataProcess_size,
                        &LSR_val, *RD_diff_data, RD_diff_size,
                        *ivd_cdd_ouput_data, ivd_cdd_ouput_size, *cff,
                        *scd_fit_data, scd_fit_size, &R_p2, &EFC,
                        *ABSD_orig_data, ABSD_orig_size, *ABSD_data, ABSD_size, *
                        f_data, f_size, *f_new_data, f_new_size, &sht, &sht2,
...
void Coder_RT_PCR_analyzer_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Coder_RT_PCR_analyzer_xil_terminate();
}

void Coder_RT_PCR_analyzer_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void Coder_RT_PCR_analyzer_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_Coder_RT_PCR_analyzer_api.c) */

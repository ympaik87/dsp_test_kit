...
#include "main.h"
#include "Coder_RT_PCR_analyzer_terminate.h"
#include "Coder_RT_PCR_analyzer_initialize.h"

/* Function Declarations */
static void argInit_d100x1_real_T(double result_data[], int result_size[1]);
static double argInit_real_T(void);
static void main_Coder_RT_PCR_analyzer(void);
...
static void main_Coder_RT_PCR_analyzer(void)
{
  ...
  /* Initialize function 'Coder_RT_PCR_analyzer' input arguments. */
  ...
  /* Call the entry-point 'Coder_RT_PCR_analyzer'. */
  Coder_RT_PCR_analyzer(x_data, x_size, RD_data, RD_size, perturbation_data,
                        perturbation_size, SFC_tmp, SFC_tmp, argInit_real_T(),
                        argInit_real_T(), argInit_real_T(), argInit_real_T(),
                        argInit_real_T(), argInit_real_T(), argInit_real_T(),
                        argInit_real_T(), argInit_real_T(), argInit_real_T(),
                        argInit_real_T(), argInit_real_T(), argInit_real_T(),
                        argInit_real_T(), &result_well, &DataProcessNum,
                        DataProcess_data, DataProcess_size, &LSR_val,
                        RD_diff_data, RD_diff_size, ivd_cdd_ouput_data,
                        ivd_cdd_ouput_size, cff, scd_fit_data, scd_fit_size,

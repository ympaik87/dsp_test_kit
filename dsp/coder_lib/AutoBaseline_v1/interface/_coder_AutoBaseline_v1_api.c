...
void AutoBaseline_v1_api(const mxArray * const prhs[19], int32_T nlhs, const
  mxArray *plhs[21])
{
  real_T (*DataProcess_data)[800];
  real_T (*RD_diff_data)[100];
  real_T (*ivd_cdd_data)[100];
  real_T (*cff)[2];
  ...
  ivd_cdd_data = (real_T (*)[100])mxMalloc(sizeof(real_T [100]));
  ...
  AutoBaseline_v1(*x_data, x_size, *RD_data, RD_size, *perturbation_data,
                  perturbation_size, SFC, MFC, DRFU, Thrd, RPC, RC, dfM, dfC,
                  PMC, FB, AR, isPC, LinearFilter_type, ABSD_corrector_ver,
                  AsymmSigFit_ver, UseStrangePatternCorrector, &result_well,
                  &DataProcessNum, *DataProcess_data, DataProcess_size, &LSR_val,
                  *RD_diff_data, RD_diff_size, *ivd_cdd_data, ivd_cdd_size, *cff,
                  *scd_fit_data, scd_fit_size, &R_p2, &EFC, *ABSD_orig_data,
                  ABSD_orig_size, *ABSD_data, ABSD_size, *f_data, f_size,
                  *f_new_data, f_new_size, &sht, &sht2, *param, *param_new, &R2,
                  &EndRFU, &df);
  ...
  if (nlhs > 5) {
    plhs[5] = b_emlrt_marshallOut(*ivd_cdd_data, ivd_cdd_size);
  }
...
void AutoBaseline_v1_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  AutoBaseline_v1_xil_terminate();
}

void AutoBaseline_v1_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void AutoBaseline_v1_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_AutoBaseline_v1_api.c) */

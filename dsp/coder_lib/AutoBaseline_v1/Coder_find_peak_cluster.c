  ...
  *height = 0.0;
  ...
  if (SC > 1.0) {
    if (rtIsInf(SC - 1.0) && (SC - 1.0 == 1.0)) {
      ...
      for (i9 = 0; i9 <= set1_cycle_right; i9++) {
        y_data[i9] = (SC - 1.0) - (double)i9;
      }
    } else {
    ...
    i9 = set2->size[0] * set2->size[1];
    set2->size[0] = 1;
    set2->size[1] = n;
    emxEnsureCapacity_real_T(set2, i9);
    for (i9 = 0; i9 < n; i9++) {
      set2->data[i9] = 1.0E-5 * y_data[i9];
    }
    ...
    if (rotated_RD_data[0] < rotated_RD_data[1]) {
      ...
      for (i9 = 0; i9 < set1_cycle_right; i9++) {
        set2_data[i9] = -set2->data[i9];
      }

      set1_cycle_right = rotated_RD_size[0];
      for (i9 = 0; i9 < set1_cycle_right; i9++) {
        set2_data[i9 + set2->size[1]] = rotated_RD_data[i9];
      }
  ...
  for (i9 = 0; i9 < set1_cycle_right; i9++) {
    x->data[i9] = iidx->data[i9];
  }

  set1_cycle_right = iidx->size[0];
  for (i9 = 0; i9 < set1_cycle_right; i9++) {
    si_data[i9] = iidx->data[i9];
  }
  ...
  set2->size[1] = 0;
  j = 1;
  i9 = set1->size[0] * set1->size[1];
  set1->size[0] = 1;
  set1->size[1] = 1;
  emxEnsureCapacity_int32_T(set1, i9);
  ...
  for (i = 0; i <= i9 - 2; i++) {
    if (j == 1) {
      /* min(abs(set1-si(i)),[],2) */
      i10 = b_set1->size[0] * b_set1->size[1];
      b_set1->size[0] = 1;
      b_set1->size[1] = set1->size[1];
      emxEnsureCapacity_real_T(b_set1, i10);
      nm1d2 = (int)x->data[1 + i];
      set1_cycle_right = set1->size[0] * set1->size[1];
      for (i10 = 0; i10 < set1_cycle_right; i10++) {
        b_set1->data[i10] = (double)set1->data[i10] - (double)nm1d2;
      }
      ...
      if (ndbl <= 3.0) {
        ...
        if (guard1 && (((int)x->data[1 + i] > 2) && ((int)x->data[1 + i] <
          ...
          if (idx == 0) {
            ...
            nm1d2 = idx + 1;
            for (k = nm1d2; k < 6; k++) {
              if (ndbl > rotated_RD_data[(iv0[k - 1] + i10) + 3]) {
                ndbl = rotated_RD_data[k + i10];
              }
            }
          }

          if (rotated_RD_data[(int)x->data[1 + i] - 1] <= ndbl) {
            i10 = set2->size[0] * set2->size[1];
            set2->size[0] = 1;
            set2->size[1] = 1;
            emxEnsureCapacity_real_T(set2, i10);
      ...
      for (i10 = 0; i10 < set1_cycle_right; i10++) {
        b_set1->data[i10] = set2->data[i10] - (double)nm1d2;
      }
  ...
  if (set2->size[1] != 0) {
    ...
    if (guard2) {
      i9 = set1->size[1];
      i10 = b_set2->size[0] * b_set2->size[1];
      b_set2->size[0] = 1;
      b_set2->size[1] = set2->size[1];
      emxEnsureCapacity_int32_T(b_set2, i10);
      set1_cycle_right = set2->size[0] * set2->size[1];
      for (i10 = 0; i10 < set1_cycle_right; i10++) {
        b_set2->data[i10] = (int)set2->data[i10];
      }

      set1_cycle_right = b_set2->size[1];
      i10 = set1->size[0] * set1->size[1];
      set1->size[1] = i9 + set1_cycle_right;
      emxEnsureCapacity_int32_T(set1, i10);
      for (i10 = 0; i10 < set1_cycle_right; i10++) {
        set1->data[i9 + i10] = (int)set2->data[i10];
      }
  ...
  if (set2->size[1] != 0) {
    ...
    for (i10 = 0; i10 < nm1d2; i10++) {
      set2_data[i10] = rotated_RD_data[i9 + i10];
    }

...
#include "main.h"
#include "AutoBaseline_v1_terminate.h"
#include "AutoBaseline_v1_initialize.h"

/* Function Declarations */
static void argInit_d100x1_real_T(double result_data[], int result_size[1]);
static double argInit_real_T(void);
static void main_AutoBaseline_v1(void);
...
static void main_AutoBaseline_v1(void)
{
  ...
  /* Initialize function 'AutoBaseline_v1' input arguments. */
  ...
  /* Call the entry-point 'AutoBaseline_v1'. */

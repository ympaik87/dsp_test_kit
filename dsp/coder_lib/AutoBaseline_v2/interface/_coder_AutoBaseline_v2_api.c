/*
 * _coder_AutoBaseline_v2_api.c
 *
 * Code generation for function '_coder_AutoBaseline_v2_api'
 *
 */
...
void AutoBaseline_v2_api(const mxArray * const prhs[17], int32_T nlhs, const
  mxArray *plhs[21])
{
  ...
  AutoBaseline_v2(*x_data, x_size, *RD_data, RD_size, *perturbation_data,
                  perturbation_size, SFC, MFC, DRFU, Thrd, RPC, RC, dfM, dfC,
                  PMC, FB, AR, isPC, *ver_array_data, ver_array_size, DS,
                  &result_well, &DataProcessNum, *DataProcess_data,
                  DataProcess_size, &LSR_val, *RD_diff_data, RD_diff_size,
                  *ivd_cdd_data, ivd_cdd_size, *cff, *scd_fit_data, scd_fit_size,
                  &R_p2, &EFC, *ABSD_orig_data, ABSD_orig_size, *ABSD_data,
                  ABSD_size, *f_data, f_size, *f_new_data, f_new_size, &sht,
                  &sht2, *param, *param_new, &R2, &EndRFU, &df);
...
void AutoBaseline_v2_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  AutoBaseline_v2_xil_terminate();
}

void AutoBaseline_v2_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void AutoBaseline_v2_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_AutoBaseline_v2_api.c) */

  ...
  double *SRFU)
{
  ...
  *SRFU = 0.0;
  ...
  if ((RDS > 500.0 * AR) && (FB == 0.0)) {
    /*       if (RDS>700*AR) && (FB==0) */
    i40 = (int)HTC - 1;
    abc = RD_data[i40] - RD_data[RDS_tmp_tmp];
    if (abc > 0.0) {
      abc /= RDS;
      if (abc > 0.7) {
        quick_amp = 1;
        *EFC = 5.0;
        ...
        if (abc > 0.4) {
          ...
          for (i41 = 0; i41 < loop_ub; i41++) {
            rotated_RD_data[i41] = (RD_data[i41] - abc * (x_data[i41] - SFC)) -
              RD_data[RDS_tmp_tmp];
          }
          ...
          for (n = 0; n < loop_ub; n++) {
            b_rotated_RD_data[n] = rotated_RD_data[i41 + n];
          }
    ...
    if (quick_amp == 1) {
      ...
      i41 = varargin_1->size[0];
      loop_ub = (int)(HTC - 1.0);
      varargin_1->size[0] = (loop_ub + RDS_tmp) - i40;
      emxEnsureCapacity_real_T(varargin_1, i41);
      for (i41 = 0; i41 < loop_ub; i41++) {
        varargin_1->data[i41] = rtMinusInf;
      }

      n = RDS_tmp - i40;
      for (i41 = 0; i41 < n; i41++) {
        varargin_1->data[i41 + loop_ub] = RD_data[i40 + i41];
      }
      ...
      if (varargin_1->size[0] <= 2) {
        ...
        if (RDS_tmp == 0) {
          ...
          i40 = RDS_tmp + 1;
          for (loop_ub = i40; loop_ub <= n; loop_ub++) {
      ...
      c_RD_size[0] = n;
      for (i41 = 0; i41 < n; i41++) {
        rotated_RD_data[i41] = RD_data[i40 + i41];
      }
    ...
    if (quick_amp == 1) {
      ...
      if (rtIsNaN(*EFC)) {
        ...
        emxEnsureCapacity_real_T(y, i40);
        for (i40 = 0; i40 <= n; i40++) {
          y->data[i40] = 1.0 + (double)i40;
        }
      }

      i40 = varargin_1->size[0];
      varargin_1->size[0] = y->size[1];
      emxEnsureCapacity_real_T(varargin_1, i40);
      n = y->size[1];
      for (i40 = 0; i40 < n; i40++) {
        varargin_1->data[i40] = y->data[i40];
      }
      ...
      if ((abc > 0.5) && (abc <= 1.5)) {
        ...
        *EFC0 = *EFC;
        ...
        for (i40 = 0; i40 < loop_ub; i40++) {
          scd_fit_data[i40] = cff0_idx_0 * (x_data[i40] - 50.0) * (x_data[i40] -
            50.0) + cff0_idx_1;
        }
        ...
        *SRFU = combineVectorElements(&c_ABSD_data) / (double)loop_ub;
        ...
        if (abc > 1.5) {
          ...
          *EFC0 = 5.0;
          ...
          loop_ub = x_size[0];
          for (i40 = 0; i40 < loop_ub; i40++) {
            scd_fit_data[i40] = 0.0 * (x_data[i40] - 50.0) * (x_data[i40] - 50.0)
              + cff[1];
          }

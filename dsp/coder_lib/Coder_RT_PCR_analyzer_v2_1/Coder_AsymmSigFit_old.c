  ...
  if ((param3 > SFC) && (param3 < TC - 2.0) && (EFC0 < TC - 2.0)) {
    if (EFC0 + 2.0 < EFC0 - 2.0) {
      ...
      check_itv->size[1] = 0;
                ...
                EFC0 + 2.0)) {
      i82 = check_itv->size[0] * check_itv->size[1];
      check_itv->size[0] = 1;
      check_itv->size[1] = 1;
      emxEnsureCapacity_real_T(check_itv, i82);
      ...
      emxEnsureCapacity_real_T(check_itv, i82);
      for (i82 = 0; i82 <= n; i82++) {
        check_itv->data[i82] = (EFC0 - 2.0) + (double)i82;
      }
    } else {
    ...
    ndbl = f_data[0];
    i82 = varargin_1->size[0];
    varargin_1->size[0] = check_itv->size[1];
    emxEnsureCapacity_real_T(varargin_1, i82);
    n = check_itv->size[1];
    for (i82 = 0; i82 < n; i82++) {
      varargin_1->data[i82] = ((f_data[(int)check_itv->data[i82] - 1] -
        ABSD_data[(int)check_itv->data[i82] - 1]) - ndbl) + SRFU;
    }
        ...
        if (cdiff == 0.0) {
          ...
          if (ndbl == 0.0) {
            ...
            if (*result_well == 0.0) {
              ...
              i82 = (int)param3;
              f_data[i82 - 1] = (f_new_data[i82 - 2] + f_new2_data[i82]) / 2.0;
              if (1.0 > param3 - 1.0) {
                i83 = 0;
              } else {
                i83 = (int)param3 - 1;
              ...
              n = SRFU_tmp_tmp_tmp - i82;
              for (nm1d2 = 0; nm1d2 <= n; nm1d2++) {
                f_data[(k + nm1d2) - 1] = f_new2_data[(i82 + nm1d2) - 1];
              }

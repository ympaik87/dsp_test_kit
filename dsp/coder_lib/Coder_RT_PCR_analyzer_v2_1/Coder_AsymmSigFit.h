...
#ifndef CODER_ASYMMSIGFIT_H
#define CODER_ASYMMSIGFIT_H
...
extern "C" {
  ...
  extern void Coder_AsymmSigFit(const double x_data[], const int x_size[1],
...
/* End of code generation (Coder_AsymmSigFit.h) */

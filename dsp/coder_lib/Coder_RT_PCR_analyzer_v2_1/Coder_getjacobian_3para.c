  ...
  int x_size[1], double J_data[], int J_size[2])
{
  ...
  for (i34 = 0; i34 < loop_ub; i34++) {
    Cmm1_tmp_data[i34] = param[2] - x_data[i34];
  }

  param_size[0] = x_size[0];
  loop_ub = x_size[0];
  for (i34 = 0; i34 < loop_ub; i34++) {
    param_data[i34] = param[3] * Cmm1_tmp_data[i34];
  }
  ...
  loop_ub = Cmm1_size[0];
  for (i34 = 0; i34 < loop_ub; i34++) {
    Cmm2_data[i34] = 1.0 + Cmm1_data[i34];
  }

  loop_ub = Cmm2_size[0];
  for (i34 = 0; i34 < loop_ub; i34++) {
    J_data[i34] = 1.0 / Cmm2_data[i34];
  }

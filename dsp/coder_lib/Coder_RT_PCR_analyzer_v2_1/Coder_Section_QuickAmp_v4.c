  ...
  double *SRFU)
{
  ...
  *SRFU = 0.0;
  ...
  if ((RDS > 500.0 * AR) && (FB == 0.0)) {
    loop_ub = (int)HTC;
    i53 = loop_ub - 1;
    ndbl = RD_data[i53] - RD_data[RDS_tmp_tmp];
    if (ndbl > 0.0) {
      ndbl /= RDS;
      if (ndbl > 0.7) {
        quick_amp = 1;
        *EFC = 5.0;
        ...
        if (ndbl > 0.4) {
          ...
          n = RD_size[0];
          for (i54 = 0; i54 < n; i54++) {
            rotated_RD_data[i54] = (RD_data[i54] - abc * (x_data[i54] - SFC)) -
              RD_data[RDS_tmp_tmp];
          }
          ...
          rotated_RD_size[0] = n;
          for (nx = 0; nx < n; nx++) {
            b_rotated_RD_data[nx] = rotated_RD_data[i54 + nx];
          }
    ...
    if (quick_amp == 1) {
      ...
      i54 = varargin_1->size[0];
      n = (int)(HTC - 1.0);
      varargin_1->size[0] = (n + RDS_tmp) - i53;
      emxEnsureCapacity_real_T(varargin_1, i54);
      for (i54 = 0; i54 < n; i54++) {
        varargin_1->data[i54] = rtMinusInf;
      }

      nx = RDS_tmp - i53;
      for (i54 = 0; i54 < nx; i54++) {
        varargin_1->data[i54 + n] = RD_data[i53 + i54];
      }
      ...
      if (varargin_1->size[0] <= 2) {
        ...
        if (idx == 0) {
          ...
          i53 = idx + 1;
          for (RDS_tmp = i53; RDS_tmp <= n; RDS_tmp++) {
      ...
      c_RD_size[0] = nx;
      for (i54 = 0; i54 < nx; i54++) {
        rotated_RD_data[i54] = RD_data[i53 + i54];
      }
    ...
    if (quick_amp >= 1) {
      ...
      if (quick_amp == 1) {
        ...
        emxEnsureCapacity_real_T(varargin_1, i53);
        for (i53 = 0; i53 < nx; i53++) {
          varargin_1->data[i53] = RD_data[i53] / abc * TC;
        }

        Coder_Indirect_curvature_v3(varargin_1->data, HTC + 3.0, tmp_data,
          tmp_size);
        i53 = fit_intv->size[0] * fit_intv->size[1];
        fit_intv->size[0] = 1;
        fit_intv->size[1] = tmp_size[1];
        emxEnsureCapacity_real_T(fit_intv, i53);
        loop_ub = tmp_size[0] * tmp_size[1];
        for (i53 = 0; i53 < loop_ub; i53++) {
          fit_intv->data[i53] = tmp_data[i53];
        }
        ...
        if (nx == 0) {
          ...
          apnd = min5_idx[nx - 1];
          i53 = nx + 1;
          for (RDS_tmp = i53; RDS_tmp < 6; RDS_tmp++) {
      ...
      if (*EFC < 10.0) {
        if (rtIsNaN(*EFC)) {
          ...
          emxEnsureCapacity_real_T(fit_intv, i53);
          for (i53 = 0; i53 <= loop_ub; i53++) {
            fit_intv->data[i53] = 1.0 + (double)i53;
          }
        }
      } else {
        cff0_idx_0 = *EFC - 8.0;
        ...
        } else if ((rtIsInf(cff0_idx_0) || rtIsInf(*EFC)) && (cff0_idx_0 == *EFC))
        {
          ...
          emxEnsureCapacity_real_T(fit_intv, i53);
          for (i53 = 0; i53 <= loop_ub; i53++) {
            fit_intv->data[i53] = cff0_idx_0 + (double)i53;
          }
        } else {
      ...
      i53 = b_fit_intv->size[0];
      b_fit_intv->size[0] = fit_intv->size[1];
      emxEnsureCapacity_real_T(b_fit_intv, i53);
      loop_ub = fit_intv->size[1];
      for (i53 = 0; i53 < loop_ub; i53++) {
        b_fit_intv->data[i53] = fit_intv->data[i53];
      }
      ...
      loop_ub = fit_intv->size[1];
      for (i53 = 0; i53 < loop_ub; i53++) {
        varargin_1->data[i53] = RD_data[(int)fit_intv->data[i53] - 1];
      }
      ...
      if ((abc > 0.5) && (abc <= 1.5)) {
        ...
        *EFC0 = *EFC;
        ...
        loop_ub = x_size[0];
        for (i53 = 0; i53 < loop_ub; i53++) {
          scd_fit_data[i53] = cff0_idx_0 * (x_data[i53] - 50.0) * (x_data[i53] -
            50.0) + ndbl;
        }
        ...
        loop_ub = RD_size[0];
        for (i53 = 0; i53 < loop_ub; i53++) {
          ABSD_data[i53] = RD_data[i53] - scd_fit_data[i53];
        }
        ...
        *R_p2 = 1.0;
        ...
        loop_ub = fit_intv->size[1];
        for (i53 = 0; i53 < loop_ub; i53++) {
          varargin_1->data[i53] = ABSD_data[(int)fit_intv->data[i53] - 1];
        }
        ...
        *EFC0 = 5.0;
        ...
        loop_ub = x_size[0];
        for (i53 = 0; i53 < loop_ub; i53++) {
          scd_fit_data[i53] = 0.0 * (x_data[i53] - 50.0) * (x_data[i53] - 50.0)
            + cff[1];
        }
        ...
        loop_ub = nx - 1;
        for (i53 = 0; i53 <= loop_ub; i53++) {
          b_tmp_data[i53] = (signed char)i53;
        }

        for (i53 = 0; i53 < nx; i53++) {
          ABSD_data[b_tmp_data[i53]] = 0.0;
        }
